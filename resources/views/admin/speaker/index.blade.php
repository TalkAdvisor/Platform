            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="speakerForm" action='{{url('talker')}}' method="POST" class="form-horizontal" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input name="talker-lang" type="radio" value="1" @if (old( 'talker-lang')=="1" ) checked @endif>中文</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input name="talker-lang" type="radio" value="2" @if (old( 'talker-lang')=="2" ) checked @endif>英文</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input name="talker-lang" type="radio" value="999" @if (old( 'talker-lang')=="999" ) checked @endif>其他
